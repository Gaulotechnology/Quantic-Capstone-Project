...
export const ServicesPage: React.FC = () => (
  <PublicPageLayout title="Our Consultancy Services">
    <Typography variant="body1" sx={{ mb: 4 }}>
      We provide end-to-end recruitment solutions powered by AI and decades of human experience.
    </Typography>
    <Grid container spacing={4}>
      {[
        { title: 'Executive Search', desc: 'Retained search for board and leadership levels.' },
        { title: 'Technical Scouting', desc: 'Deep-dive searches for specialized engineering talent.' },
        { title: 'Graduate Programs', desc: 'Scaling entry-level talent for innovative hubs.' }
      ].map(s => (
